import { createContext, useState, useEffect, createElement, useContext, cloneElement } from 'react';
...
var FormContext = /*#__PURE__*/createContext(initialState.value);
...
var Form = function Form(_ref) {
  ...
  return createElement(FormContext.Provider, {
    value: state
  }, createElement("form", Object.assign({}, rest, {
...
var FormConsumer = function FormConsumer(_ref) {
  var children = _ref.children;
  return createElement(FormContext.Consumer, null, children);
};
...
var Field = function Field(_ref) {
  ...
  var _React$useContext = useContext(FormContext),
  ...
  var _React$useState2 = useState(valueByName),
  ...
  return cloneElement(children, _extends({}, rest, {}, valueAttr, {
    name: name,
...
var Validator = function Validator(_ref) {
  ...
  return cloneElement(element, _extends({}, rest, {
...
var withValidation = function withValidation(_ref) {
  ...
  return function (FormField) {
    return createElement(Validator, {
      name: name,
      validation: validation
    }, createElement(FormField, Object.assign({
      name: name
    }, rest)));
  };
};

export { Field, Form, FormConsumer, FormContext, Validator, debounce, initialState, omit, withValidation };
//# sourceMappingURL=react-form-core.esm.js.map
